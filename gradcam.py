...
@hydra.main(version_base=None, config_path='config', config_name='gradcam')
def main(cfg: DictConfig):
    ...
    # calculate attribution by Grad-CAM
    gradcam = captum.attr.LayerGradCam(
        model,
        model.stages[3].blocks[2].drop_path, # <=== only layer needs to be defined here !!!
        device_ids=cfg.gradcam.device_ids
        )
